...
hero:
  ...
  actions:
    - theme: brand
      ...
      link: /quick-start
    - theme: alt
      text: Browse the 12 Guidelines
      link: /guides/01-six-tools
...
features:
  ...
  - title: CLI Scaffolding Tool
    details: Run `npm create claude-project`. Answer 5 questions. Get your entire setup generated in under 60 seconds.
