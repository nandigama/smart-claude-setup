...
| | What it gives you |
|---|---|
| **[Template Repo](#template-repo)** | Pre-built `ABOUT_ME/`, `TEMPLATES/`, `CLAUDE_OUTPUTS/` folders + 64 Skills + global instructions templates. Clone and fill in your details. |
...
│   └── skills/        ← 64 pre-built slash commands
└── global-instructions/
...
Asks a few questions. Generates the full folder structure with your details pre-filled. Done.
...
| 7 | Turn repeat workflows into Skills | 64 pre-built skills |
